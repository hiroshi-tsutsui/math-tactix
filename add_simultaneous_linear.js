    ...
    <Card className="w-full shadow-lg border-blue-100">
      <CardHeader className="bg-gradient-to-r from-blue-50 to-indigo-50 border-b border-blue-100 pb-6">
        <div className="flex justify-between items-center">
          ...
          <Badge variant={overlap ? "default" : "destructive"} className="text-sm px-3 py-1 bg-white">
            <span className={overlap ? "text-blue-600" : "text-red-600"}>{overlap ? '解あり' : '解なし'}</span>
          </Badge>
        </div>
      </CardHeader>
...
console.log('Created app/components/math/SimultaneousLinearInequalitiesViz.tsx');
