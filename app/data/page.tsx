...
export default function DataPage() {
  ...
  const getLevels = () => [
    ...
    },
    {
      ...
      targetR: 0,
      name: '箱ひげ図と四分位数（発展）',
      desc: 'ユーザーが入力したデータから五数要約・外れ値を計算し、箱ひげ図を描画する',
      logStart: '四分位数シミュレータ起動',
      logGuide: 'データを入力して箱ひげ図の変化を確認してください。'
    },
    {
      id: 14,
      targetR: 0,
    ...
    },
    {
      ...
      targetR: 0,
      name: '分散・標準偏差の変換',
      desc: 'データ変換 y=kx+a における平均・分散・標準偏差の変化の性質を視覚化する',
      logStart: '変換性質シミュレータ起動',
      logGuide: 'aとkを操作して、統計量の変化を確認してください。'
    },
    {
      id: 19,
      targetR: 0,
      ...
      <main className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-4 space-y-6">
          <div className="bg-slate-900 rounded-3xl p-8 text-white shadow-xl">
            ...
            <span className="text-xs text-slate-500 mt-3 inline-block">📺 解説動画 準備中</span>
          </div>
